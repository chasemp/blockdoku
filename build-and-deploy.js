...
/**
 * BUILD/DEPLOY SCRIPT (synced with vite.config.js):
 *
 * This script is now DEPRECATED for normal builds - Vite handles everything!
 * 
 * Current build process:
 * - Vite builds from /src to /docs (configured in vite.config.js)
 * - All necessary files are automatically included by Vite
 * - Build metadata is generated by pre/post build hooks in package.json
 *
 * This script may be kept for backward compatibility or custom deployments,
 * but regular workflow should use: npm run build
 *
 * ⚠️  WARNING: This script references old 'dist/' directory and may not work correctly
 * with the new /docs build output. Use direct Vite build instead.
 */
