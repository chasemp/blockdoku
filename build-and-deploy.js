...
/**
 * BUILD/DEPLOY NOTE:
 * This script assumes build metadata has been generated by
 * `scripts/generate-build-info.js` (wired via npm prebuild/postbuild).
 * If you call this script directly, run the generator first:
 *   node scripts/generate-build-info.js
 * The Settings → About UI uses build-info.json to display version/build.
 */
