...
2. Select "Apps" then "Install this site as an app"`:'To install this app, look for an "Install" or "Add to Home Screen" option in your browser menu.'}showUpdateNotification(){const t=document.createElement("div");t.className="update-notification",t.innerHTML=`
        ...
        `,document.head.appendChild(e),document.body.appendChild(t),setTimeout(()=>{t.parentNode&&t.remove()},1e4)}isPWASupported(){return"serviceWorker"in navigator&&"PushManager"in window}setupSettingsButton(){document.readyState==="loading"?document.addEventListener("DOMContentLoaded",()=>{this.initializeSettingsButton()}):this.initializeSettingsButton()}initializeSettingsButton(){this.settingsInstallButton=document.getElementById("pwa-install-button"),this.settingsInstallButton&&(this.settingsInstallButton.addEventListener("click",()=>{this.installApp()}),this.updateSettingsButtonStatus())}updateSettingsButtonStatus(){if(!this.settingsInstallButton)return;const t=document.getElementById("install-status");this.isInstalled?(this.settingsInstallButton.classList.add("installed"),t&&(t.textContent="Installed as PWA")):this.deferredPrompt?(this.settingsInstallButton.classList.remove("installed"),t&&(t.textContent="")):(this.settingsInstallButton.classList.remove("installed"),t&&(t.textContent="Not available"))}getStatus(){return{isInstalled:this.isInstalled,canInstall:!!this.deferredPrompt,isPWASupported:this.isPWASupported(),isOnline:navigator.onLine}}}const l=Object.freeze(Object.defineProperty({__proto__:null,PWAInstallManager:a},Symbol.toStringTag,{value:"Module"}));class c{constructor(){this.container=null,this.resolve=null,this.reject=null,this.init()}init(){this.createDialog(),this.setupEventListeners()}createDialog(){this.container=document.createElement("div"),this.container.className="confirmation-dialog-overlay",this.container.innerHTML=`
