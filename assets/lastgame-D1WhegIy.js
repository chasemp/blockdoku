import"./wood-B4vXo_re.js";/* empty css             */function g(){const s=localStorage.getItem("blockdoku_lastgame"),a=document.getElementById("game-stats-content");if(!s){a.innerHTML=`
