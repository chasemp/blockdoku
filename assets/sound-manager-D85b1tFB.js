...
2. Select "Apps" then "Install this site as an app"`:'To install this app, look for an "Install" or "Add to Home Screen" option in your browser menu.'}showUpdateNotification(){const t=document.createElement("div");t.className="update-notification",t.innerHTML=`
        ...
        `,document.head.appendChild(t)}setupEventListeners(){this.container.querySelector(".confirmation-cancel").addEventListener("click",()=>{this.hide(!1)}),this.container.querySelector(".confirmation-confirm").addEventListener("click",()=>{this.hide(!0)}),this.container.addEventListener("click",t=>{t.target===this.container&&this.hide(!1)}),document.addEventListener("keydown",t=>{t.key==="Escape"&&this.container.classList.contains("show")&&this.hide(!1)})}show(t="This action will reset your current game. Are you sure you want to continue?"){return this.init(),new Promise((o,e)=>{this.resolve=o,this.reject=e,this.container.querySelector(".confirmation-message").textContent=t,this.container.classList.add("show"),document.body.style.overflow="hidden"})}hide(t){this.container.classList.remove("show"),document.body.style.overflow="",setTimeout(()=>{this.container&&this.container.parentNode&&(this.container.parentNode.removeChild(this.container),this.container=null,this.initialized=!1)},300),this.resolve&&(this.resolve(t),this.resolve=null,this.reject=null)}destroy(){this.container&&this.container.parentNode&&this.container.parentNode.removeChild(this.container)}}class m{constructor(){this.audioContext=null,this.isEnabled=!1,this.volume=.5,this.sounds={},this.soundPresets={},this.customSoundMappings={},this.init()}init(){try{this.audioContext=new(window.AudioContext||window.webkitAudioContext),this.createSoundPresets(),this.loadCustomSoundMappings(),this.createSounds()}catch(t){console.warn("Web Audio API not supported:",t),this.isEnabled=!1}}loadCustomSoundMappings(){try{const t=localStorage.getItem("blockdoku_sound_mappings");t&&(this.customSoundMappings=JSON.parse(t))}catch(t){console.warn("Failed to load sound mappings:",t)}}saveSoundMappings(){try{localStorage.setItem("blockdoku_sound_mappings",JSON.stringify(this.customSoundMappings))}catch(t){console.warn("Failed to save sound mappings:",t)}}setCustomSound(t,o){o==="default"||o===null?delete this.customSoundMappings[t]:this.customSoundMappings[t]=o,this.saveSoundMappings(),this.createSounds()}getAvailablePresets(){return{default:{name:"Default",description:"Standard game sound"},chime:{name:"Chime",description:"Gentle bell-like tone"},beep:{name:"Beep",description:"Electronic beep"},pop:{name:"Pop",description:"Quick pop sound"},swoosh:{name:"Swoosh",description:"Whoosh effect"},ding:{name:"Ding",description:"High-pitched ding"},thud:{name:"Thud",description:"Low bass thump"},click:{name:"Click",description:"Sharp click sound"}}}createSoundPresets(){this.audioContext&&(this.soundPresets={chime:this.createChimePreset(),beep:this.createBeepPreset(),pop:this.createPopPreset(),swoosh:this.createSwooshPreset(),ding:this.createDingPreset(),thud:this.createThudPreset(),click:this.createClickPreset()})}setEnabled(t){this.isEnabled=t}setVolume(t){this.volume=Math.max(0,Math.min(1,t))}createSounds(){if(!this.audioContext)return;const t=(o,e)=>{const n=this.customSoundMappings[o];return n==="none"?null:n&&this.soundPresets[n]?this.soundPresets[n]:e.call(this)};this.sounds={blockPlace:t("blockPlace",this.createBlockPlaceSound),lineClear:t("lineClear",this.createLineClearSound),levelUp:t("levelUp",this.createLevelUpSound),combo:t("combo",this.createComboSound),speedBonus:t("speedBonus",this.createSpeedBonusSound),error:t("error",this.createErrorSound),buttonClick:t("buttonClick",this.createButtonClickSound),blockRotate:t("blockRotate",this.createBlockRotateSound),scoreGain:t("scoreGain",this.createScoreGainSound),timeWarning:t("timeWarning",this.createTimeWarningSound),timeCritical:t("timeCritical",this.createTimeCriticalSound),timeBonus:t("timeBonus",this.createTimeBonusSound),hint:t("hint",this.createHintSound),undo:t("undo",this.createUndoSound),redo:t("redo",this.createRedoSound),perfect:t("perfect",this.createPerfectSound),chain:t("chain",this.createChainSound),emptyGridBonus:t("emptyGridBonus",this.createEmptyGridBonusSound)}}getSoundEffects(){return{blockPlace:{name:"Block Placement",description:"When placing a block on the board"},lineClear:{name:"Line Clear",description:"When clearing lines"},levelUp:{name:"Level Up",description:"When advancing to next level"},combo:{name:"Combo",description:"When achieving a combo"},speedBonus:{name:"Speed Bonus",description:"When earning speed bonus points"},error:{name:"Error",description:"When an invalid action occurs"},buttonClick:{name:"Button Click",description:"Button press feedback"},blockRotate:{name:"Block Rotate",description:"When rotating a block"},scoreGain:{name:"Score Gain",description:"When earning points"},timeWarning:{name:"Time Warning",description:"Low time warning"},timeCritical:{name:"Time Critical",description:"Very low time alert"},timeBonus:{name:"Time Bonus",description:"Bonus time awarded"},hint:{name:"Hint",description:"When using a hint"},undo:{name:"Undo",description:"Undo action"},redo:{name:"Redo",description:"Redo action"},perfect:{name:"Perfect Clear",description:"Perfect board clear"},chain:{name:"Chain",description:"Chain combo effect"},emptyGridBonus:{name:"Empty Grid Bonus",description:"When earning empty grid bonus points"}}}getGroupedSoundEffects(){return{events:{name:"Events",description:"General gameplay actions like block placement and UI interactions",sounds:["blockPlace","blockRotate","buttonClick","undo","redo","hint"]},success:{name:"Success",description:"Achievements, rewards, and successful actions",sounds:["lineClear","levelUp","combo","speedBonus","scoreGain","perfect","chain","timeBonus","emptyGridBonus"]},warning:{name:"Warning",description:"Time pressure alerts and urgent notifications",sounds:["timeWarning","timeCritical"]},failure:{name:"Failure",description:"Mistakes and invalid actions",sounds:["error"]}}}previewSound(t){if(!(!this.audioContext||!this.isEnabled))try{if(t==="none")return;const o=t==="default"?this.createBlockPlaceSound():this.soundPresets[t];if(!o)return;const e=this.audioContext.createBufferSource(),n=this.audioContext.createGain();e.buffer=o.buffer,e.connect(n),n.connect(this.audioContext.destination),n.gain.value=this.volume*o.volume,e.start()}catch(o){console.warn("Error previewing sound:",o)}}play(t){if(!(!this.isEnabled||!this.audioContext||!this.sounds[t]))try{const o=this.sounds[t];if(o===null)return;const e=this.audioContext.createBufferSource(),n=this.audioContext.createGain();e.buffer=o.buffer,e.connect(n),n.connect(this.audioContext.destination),n.gain.value=this.volume*o.volume,e.start()}catch(o){console.warn("Error playing sound:",o)}}createBlockPlaceSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.08,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=300-n*200;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*20)*.4}return{buffer:t,volume:.7}}createLineClearSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.3,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=400+Math.sin(n*20)*100;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*3)*.4}return{buffer:t,volume:.8}}createLevelUpSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.5,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=200+n*400;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*2)*.5}return{buffer:t,volume:.9}}createComboSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.2,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=600+Math.sin(n*30)*200;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*5)*.3}return{buffer:t,volume:.6}}createSpeedBonusSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.12,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=500+n*800,s=Math.exp(-n*8);o[e]=Math.sin(2*Math.PI*a*n)*s*.4}return{buffer:t,volume:.7}}createErrorSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.15,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=200-n*100;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*8)*.4}return{buffer:t,volume:.5}}createButtonClickSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.05,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate;o[e]=Math.sin(2*Math.PI*1e3*n)*Math.exp(-n*20)*.2}return{buffer:t,volume:.4}}createBlockRotateSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.08,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=300+Math.sin(n*50)*50;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*15)*.15}return{buffer:t,volume:.3}}createScoreGainSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.12,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=500+n*200;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*6)*.25}return{buffer:t,volume:.5}}createTimeWarningSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.2,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=300+Math.sin(n*10)*50;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*4)*.3}return{buffer:t,volume:.6}}createTimeCriticalSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.1,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=400+Math.sin(n*50)*100;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*8)*.4}return{buffer:t,volume:.7}}createTimeBonusSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.15,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=200+n*600;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*3)*.35}return{buffer:t,volume:.6}}createHintSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.25,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=150+Math.sin(n*8)*30;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*2)*.2}return{buffer:t,volume:.4}}createUndoSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.08,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=400-n*200;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*12)*.25}return{buffer:t,volume:.4}}createRedoSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.08,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=200+n*400;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*12)*.25}return{buffer:t,volume:.4}}createPerfectSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.6,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=100+n*800,s=Math.sin(2*Math.PI*a*n)+.5*Math.sin(2*Math.PI*a*2*n)+.25*Math.sin(2*Math.PI*a*3*n);o[e]=s*Math.exp(-n*1.5)*.4}return{buffer:t,volume:.8}}createChainSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.3,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=300+Math.sin(n*15)*100;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*2)*.3}return{buffer:t,volume:.5}}createEmptyGridBonusSound(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*1.2,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=200+n*400,s=Math.sin(2*Math.PI*a*n)+.6*Math.sin(2*Math.PI*a*2*n)+.4*Math.sin(2*Math.PI*a*3*n)+.2*Math.sin(2*Math.PI*a*4*n),i=1+.1*Math.sin(2*Math.PI*8*n);o[e]=s*i*Math.exp(-n*.8)*.4}return{buffer:t,volume:.6}}resume(){this.audioContext&&this.audioContext.state==="suspended"&&this.audioContext.resume()}stop(){this.audioContext&&(this.audioContext.close(),this.init())}createChimePreset(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.3,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=880;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*5)*.3+.5*Math.sin(2*Math.PI*a*2*n)*Math.exp(-n*5)*.3}return{buffer:t,volume:.7}}createBeepPreset(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.1,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate;o[e]=Math.sin(2*Math.PI*1200*n)*Math.exp(-n*15)*.3}return{buffer:t,volume:.6}}createPopPreset(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.08,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=300-n*200;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*20)*.4}return{buffer:t,volume:.7}}createSwooshPreset(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.2,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=100+n*400;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*6)*.25}return{buffer:t,volume:.5}}createDingPreset(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.25,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=1760;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*6)*.35}return{buffer:t,volume:.6}}createThudPreset(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.12,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate,a=100-n*50;o[e]=Math.sin(2*Math.PI*a*n)*Math.exp(-n*12)*.5}return{buffer:t,volume:.8}}createClickPreset(){const t=this.audioContext.createBuffer(1,this.audioContext.sampleRate*.04,this.audioContext.sampleRate),o=t.getChannelData(0);for(let e=0;e<o.length;e++){const n=e/this.audioContext.sampleRate;o[e]=Math.sin(2*Math.PI*1500*n)*Math.exp(-n*30)*.25}return{buffer:t,volume:.5}}getGroupedSoundSettings(){const t={},o=this.getGroupedSoundEffects(),e=this.customSoundMappings||{};for(const[n,a]of Object.entries(o)){const s=a.sounds.map(l=>e[l]||"default"),i=[...new Set(s)];i.length===1?t[n]=i[0]:t[n]="mixed"}return t}setGroupedSoundSettings(t,o){const n=this.getGroupedSoundEffects()[t];if(n)for(const a of n.sounds)this.setCustomSound(a,o)}previewGroupedSound(t){var s;const e=this.getGroupedSoundEffects()[t];if(!e||e.sounds.length===0)return;const n=e.sounds[0],a=((s=this.customSoundMappings)==null?void 0:s[n])||"default";this.previewSound(a)}}export{h as C,u as G,c as P,m as S,d as i};
