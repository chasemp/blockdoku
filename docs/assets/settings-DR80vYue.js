import"./modulepreload-polyfill-B5Qt9EMX.js";/* empty css             *//* empty css             */import{G as O,C as R,P as j}from"./confirmation-dialog-C_sDWQ13.js";import{S as W}from"./sound-manager-DEf2ZdWT.js";import{b as H}from"./build-info-Dwp5dZmk.js";class U{constructor(){this.storage=new O,this.settings=this.storage.loadSettings(),this.currentTheme=this.settings.theme||"wood",this.pwaInstallManager=null,this.confirmationDialog=new R,this.soundManager=new W,this.init()}init(){this.loadSettings(),this.setupEventListeners(),this.updateUI(),this.updateBuildInfo(),this.initializePWA()}initializePWA(){try{this.pwaInstallManager=new j,console.log("PWA Install Manager initialized in settings")}catch(e){console.error("Failed to initialize PWA Install Manager:",e)}}loadSettings(){console.log("Settings.js loading settings:",this.settings),this.currentTheme=this.settings.theme||"wood",console.log("Settings.js current theme:",this.currentTheme);const e=document.documentElement.getAttribute("data-theme");console.log("Current data-theme attribute:",e),!e||e!==this.currentTheme?(console.log("Applying theme from settings.js:",this.currentTheme),this.applyTheme(this.currentTheme)):console.log("Theme already applied, skipping"),this.fixSectionPlacement(),this.loadEffectsSettings()}loadEffectsSettings(){const e=document.getElementById("sound-enabled");e&&(e.checked=this.settings.soundEnabled===!0);const t=document.getElementById("sound-enabled-sounds-section");t&&(t.checked=this.settings.soundEnabled===!0);const n=document.getElementById("animations-enabled");n&&(n.checked=this.settings.animationsEnabled!==!1);const o=document.getElementById("block-hover-effects");o&&(o.checked=this.settings.blockHoverEffects!==!1);const d=document.getElementById("block-selection-glow");d&&(d.checked=this.settings.blockSelectionGlow!==!1);const i=document.getElementById("block-entrance-animations");i&&(i.checked=this.settings.blockEntranceAnimations!==!1);const u=document.getElementById("particle-effects");u&&(u.checked=this.settings.particleEffects!==!1);const a=document.getElementById("animation-speed");a&&(a.value=this.settings.animationSpeed||"normal");const c=document.getElementById("haptic-enabled");c&&(c.checked=this.settings.hapticEnabled!==!1);const r=document.getElementById("enable-hints");r&&(r.checked=this.settings.enableHints===!0);const g=document.getElementById("enable-timer");g&&(g.checked=this.settings.enableTimer===!0);const m=document.getElementById("enable-petrification");m&&(m.checked=this.settings.enablePetrification===!0);const p=document.getElementById("enable-dead-pixels");p&&(p.checked=this.settings.enableDeadPixels===!0);const E=document.getElementById("dead-pixels-intensity"),b=document.getElementById("dead-pixels-intensity-value"),w=document.getElementById("dead-pixels-intensity-container");if(E&&b){const S=this.settings.deadPixelsIntensity||0;E.value=S,b.textContent=S,w&&(w.style.display=this.settings.enableDeadPixels===!0?"block":"none")}const B=document.getElementById("auto-save");B&&(B.checked=this.settings.autoSave!==!1);const L=document.getElementById("show-points");L&&(L.checked=this.settings.showPoints===!0);const M=document.getElementById("show-placement-points");if(M&&(M.checked=this.settings.showPlacementPoints===!0),this.speedModeOrder=["ignored","bonus","punishment"],this.currentSpeedModeIndex=0,document.getElementById("speed-mode-toggle")){const S=this.settings.speedMode||"ignored";this.currentSpeedModeIndex=this.speedModeOrder.indexOf(S),this.currentSpeedModeIndex===-1&&(this.currentSpeedModeIndex=0),this.updateSpeedModeDisplay()}const x=document.getElementById("success-mode-enabled");x&&(x.checked=this.settings.successModeEnabled!==!1);const T=document.getElementById("show-speed-timer");T&&(T.checked=this.settings.showSpeedTimer===!0);const P=document.getElementById("enable-prize-recognition");P&&(P.checked=this.settings.enablePrizeRecognition!==!1);const A=document.getElementById("combo-streak"),$=document.getElementById("combo-cumulative");A&&$&&((this.settings.comboDisplayMode||"cumulative")==="cumulative"?$.checked=!0:A.checked=!0),this.updateAnimationSettingsVisibility()}updateAnimationSettingsVisibility(){const e=document.getElementById("animations-enabled"),t=document.getElementById("animation-settings");e&&t&&(e.checked?(t.style.display="block",t.style.opacity="1"):(t.style.display="none",t.style.opacity="0.5"))}setupEventListeners(){document.querySelectorAll(".nav-item[data-section]").forEach(s=>{let l=null,h=null,v=!1;const I=f=>{f.preventDefault(),this.showSection(s.dataset.section)},C=()=>{h&&(clearTimeout(h),h=null),v=!1,l=null,s.classList.remove("pressing")},D=f=>{f.preventDefault(),!v&&(v=!0,l=Date.now(),s.classList.add("pressing"),h=setTimeout(()=>{v&&(I(f),C())},10))},k=f=>{v&&(f.preventDefault(),C())};s.addEventListener("mousedown",D),s.addEventListener("mouseup",k),s.addEventListener("mouseleave",k),s.addEventListener("touchstart",D,{passive:!1}),s.addEventListener("touchend",k,{passive:!1}),s.addEventListener("touchcancel",k,{passive:!1}),s.addEventListener("click",f=>{f.preventDefault(),!v&&(!l||Date.now()-l<200)&&I(f)})}),document.querySelectorAll(".theme-option").forEach(s=>{let l=null,h=null,v=!1,I=null;const C=y=>{this.selectTheme(y)},D=()=>{h&&(clearTimeout(h),h=null),v=!1,l=null,s.classList.remove("pressing")},k=y=>{y.preventDefault(),!v&&(v=!0,l=Date.now(),I=y.currentTarget.dataset.theme,s.classList.add("pressing"),h=setTimeout(()=>{v&&I&&(C(I),D())},10))},f=y=>{v&&(y.preventDefault(),D())};s.addEventListener("mousedown",k),s.addEventListener("mouseup",f),s.addEventListener("mouseleave",f),s.addEventListener("touchstart",k,{passive:!1}),s.addEventListener("touchend",f,{passive:!1}),s.addEventListener("touchcancel",f,{passive:!1}),s.addEventListener("click",y=>{y.preventDefault(),!v&&(!l||Date.now()-l<200)&&C(y.currentTarget.dataset.theme)})});const e=document.getElementById("enable-hints");e&&e.addEventListener("change",s=>{this.updateSetting("enableHints",s.target.checked)});const t=document.getElementById("enable-timer");t&&t.addEventListener("change",s=>{this.updateSetting("enableTimer",s.target.checked)});const n=document.getElementById("enable-petrification");n&&n.addEventListener("change",s=>{this.updateSetting("enablePetrification",s.target.checked)});const o=document.getElementById("enable-dead-pixels");o&&o.addEventListener("change",s=>{this.updateSetting("enableDeadPixels",s.target.checked);const l=document.getElementById("dead-pixels-intensity-container");l&&(l.style.display=s.target.checked?"block":"none")});const d=document.getElementById("dead-pixels-intensity"),i=document.getElementById("dead-pixels-intensity-value");d&&i&&d.addEventListener("input",s=>{const l=parseInt(s.target.value);i.textContent=l,this.updateSetting("deadPixelsIntensity",l)});const u=document.getElementById("sound-enabled");u&&u.addEventListener("change",s=>{this.updateSetting("soundEnabled",s.target.checked);const l=document.getElementById("sound-enabled-sounds-section");l&&(l.checked=s.target.checked)});const a=document.getElementById("sound-enabled-sounds-section");a&&a.addEventListener("change",s=>{this.updateSetting("soundEnabled",s.target.checked);const l=document.getElementById("sound-enabled");l&&(l.checked=s.target.checked)});const c=document.getElementById("animations-enabled");c&&c.addEventListener("change",s=>{this.updateSetting("animationsEnabled",s.target.checked),this.updateAnimationSettingsVisibility()});const r=document.getElementById("block-hover-effects");r&&r.addEventListener("change",s=>{this.updateSetting("blockHoverEffects",s.target.checked)});const g=document.getElementById("block-selection-glow");g&&g.addEventListener("change",s=>{this.updateSetting("blockSelectionGlow",s.target.checked)});const m=document.getElementById("block-entrance-animations");m&&m.addEventListener("change",s=>{this.updateSetting("blockEntranceAnimations",s.target.checked)});const p=document.getElementById("particle-effects");p&&p.addEventListener("change",s=>{this.updateSetting("particleEffects",s.target.checked)});const E=document.getElementById("animation-speed");E&&E.addEventListener("change",s=>{this.updateSetting("animationSpeed",s.target.value)});const b=document.getElementById("auto-save");b&&b.addEventListener("change",s=>{this.updateSetting("autoSave",s.target.checked)});const w=document.getElementById("show-points");w&&w.addEventListener("change",s=>{this.updateSetting("showPoints",s.target.checked),this.updateBlockPointsDisplay()});const B=document.getElementById("show-placement-points");B&&B.addEventListener("change",s=>{this.updateSetting("showPlacementPoints",s.target.checked)});const L=document.getElementById("speed-mode-toggle");L&&L.addEventListener("click",s=>{s.preventDefault(),this.cycleSpeedMode()});const M=document.getElementById("success-mode-enabled");M&&M.addEventListener("change",s=>{this.updateSetting("successModeEnabled",s.target.checked)});const G=document.getElementById("show-speed-timer");G&&G.addEventListener("change",s=>{this.updateSetting("showSpeedTimer",s.target.checked)});const x=document.getElementById("enable-prize-recognition");x&&x.addEventListener("change",s=>{this.updateSetting("enablePrizeRecognition",s.target.checked)});const T=document.getElementById("combo-streak"),P=document.getElementById("combo-cumulative");T&&P&&(T.addEventListener("change",s=>{s.target.checked&&this.updateSetting("comboDisplayMode","streak")}),P.addEventListener("change",s=>{s.target.checked&&this.updateSetting("comboDisplayMode","cumulative")}));const A=document.getElementById("haptic-enabled");A&&A.addEventListener("change",s=>{this.updateSetting("hapticEnabled",s.target.checked)});const $=document.getElementById("share-button");$&&$.addEventListener("click",()=>{this.shareGame()});const S=document.getElementById("share-scores-button");S&&S.addEventListener("click",()=>{this.shareHighScores()});const N=document.getElementById("view-last-game-btn");N&&N.addEventListener("click",()=>{this.viewLastGame()});const z=document.getElementById("reset-stats");z&&z.addEventListener("click",async()=>{if(await this.confirmationDialog.show(`⚠️ PERMANENT DATA LOSS WARNING ⚠️
...
This action CANNOT be undone. Are you absolutely sure you want to continue?`)){this.storage.clearStatistics(),this.storage.clearHighScores();try{this.loadHighScores()}catch{}this.showNotification("All statistics and high scores have been permanently deleted")}});const q=document.getElementById("clear-cache-button");q&&q.addEventListener("click",async()=>{if(await this.confirmationDialog.show(`🧹 Clear Cache & Reset Service Workers
...
Continue?`))try{if("serviceWorker"in navigator){const l=await navigator.serviceWorker.getRegistrations();for(const h of l)await h.unregister(),console.log("Service worker unregistered:",h)}if("caches"in window){const l=await caches.keys();for(const h of l)await caches.delete(h),console.log("Cache deleted:",h)}this.showNotification("Cache cleared! Reloading page..."),setTimeout(()=>{window.location.reload(!0)},1500)}catch(l){console.error("Error clearing cache:",l),this.showNotification("Error clearing cache. Check console for details.")}})}showSection(e){document.querySelectorAll(".nav-item").forEach(o=>{o.classList.remove("active")});const t=document.querySelector(`[data-section="${e}"]`);t&&t.classList.add("active"),document.querySelectorAll(".settings-section").forEach(o=>{o.classList.remove("active")});const n=document.getElementById(`${e}-section`);n&&n.classList.add("active"),e==="scores"?this.loadHighScores():e==="sounds"&&this.loadSoundCustomization()}loadSoundCustomization(){const e=document.getElementById("sound-customization-container");if(!e)return;this.soundManager.setEnabled(!0);const t=this.soundManager.getGroupedSoundEffects(),n=this.soundManager.getAvailablePresets(),o=this.soundManager.getGroupedSoundSettings();let d="";for(const[a,c]of Object.entries(t)){const r=o[a]||"default",g=r==="mixed",m=r==="none";d+=`
                <div class="sound-group-item">
                    ...
                    <div class="sound-group-controls">
                        <select class="sound-group-preset-select" data-group="${a}">
                            ...
                            ${Object.entries(n).map(([p,E])=>p!=="default"?`<option value="${p}" ${r===p?"selected":""}>${E.name}</option>`:"").join("")}
                        </select>
        ...
        `,e.innerHTML=d,e.querySelectorAll(".sound-group-preset-select").forEach(a=>{a.addEventListener("change",c=>{const r=c.target.dataset.group,g=c.target.value;this.soundManager.setGroupedSoundSettings(r,g);const m=c.target.parentElement.querySelector(".sound-group-mute-btn");m&&(g==="none"?(m.classList.add("muted"),m.textContent="🔇",m.title="Unmute"):(m.classList.remove("muted"),m.textContent="🔊",m.title="Mute"));const p=c.target.closest(".sound-group-item"),E=p.querySelector(".mixed-indicator");if(g==="mixed"){if(!E){const b=p.querySelector(".sound-group-details");b.innerHTML+='<small class="mixed-indicator">⚠️ Mixed presets</small>'}}else E&&E.remove()})}),e.querySelectorAll(".sound-group-preview-btn").forEach(a=>{a.addEventListener("click",c=>{const r=c.currentTarget.dataset.group;if(c.currentTarget.parentElement.querySelector(".sound-group-preset-select").value==="none"){const p=a.textContent;a.textContent="🔇 Silent",a.style.opacity="0.6",setTimeout(()=>{a.textContent=p,a.style.opacity="1"},500)}else this.soundManager.previewGroupedSound(r)})}),e.querySelectorAll(".sound-group-mute-btn").forEach(a=>{a.addEventListener("click",c=>{const r=c.currentTarget.dataset.group,g=c.currentTarget.parentElement.querySelector(".sound-group-preset-select");g.value==="none"?(g.value="default",this.soundManager.setGroupedSoundSettings(r,"default"),a.classList.remove("muted"),a.textContent="🔊",a.title="Mute"):(g.value="none",this.soundManager.setGroupedSoundSettings(r,"none"),a.classList.add("muted"),a.textContent="🔇",a.title="Unmute")})});const i=document.getElementById("reset-all-sounds");i&&i.addEventListener("click",async()=>{await this.confirmationDialog.show("Reset all sound effects to their default sounds?")&&this.resetAllSounds()});const u=document.getElementById("show-advanced-sounds");u&&u.addEventListener("click",()=>{this.toggleAdvancedSoundSettings()})}resetAllSounds(){this.soundManager.customSoundMappings={},this.soundManager.saveSoundMappings(),this.soundManager.createSounds(),this.loadSoundCustomization(),this.showNotification("All sounds reset to default")}toggleAdvancedSoundSettings(){const e=document.getElementById("sound-customization-container");if(!e)return;e.querySelector(".sound-effect-item")?this.loadSoundCustomization():this.loadAdvancedSoundCustomization()}loadAdvancedSoundCustomization(){const e=document.getElementById("sound-customization-container");if(!e)return;this.soundManager.setEnabled(!0);const t=this.soundManager.getSoundEffects(),n=this.soundManager.getAvailablePresets(),o=this.soundManager.customSoundMappings||{};let d="";for(const[i,u]of Object.entries(t)){const a=o[i]||"default",c=a==="none";d+=`
                <div class="sound-effect-item">
                    ...
                    <select class="sound-preset-select" data-sound="${i}">
                        ...
                        ${Object.entries(n).map(([r,g])=>r!=="default"?`<option value="${r}" ${a===r?"selected":""}>${g.name}</option>`:"").join("")}
                    </select>
...
`;e.slice(0,5).forEach((i,u)=>{const a=(i.difficulty||"normal").toUpperCase(),c=new Date(i.date).toLocaleDateString();n+=`#${u+1} ${i.score.toLocaleString()} (${a}) - Level ${i.level} - ${c}
`}),n+=`
📊 Statistics:
